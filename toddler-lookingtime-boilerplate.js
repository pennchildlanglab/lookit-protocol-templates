function generateProtocol(child, pastSessions) {
    ...
    let frames = {
            ...
            "blocks": [
                {
                    ...
                    "text": "In the experiment, your toddler will listen to audio recordings of [DESCRIPTION OF AUDIO]. To make sure that your toddler can hear them well, please try playing the sample audio below.",
                    "mediaBlock": {
            ...
            "blocks": [
                {
                    ...
                    "text": "This experiment consists of [DESCRIPTION]. Your toddler will [DESCRIPTION]"
                },
                {
                    //Edit [INSTRUCTIONS] below
                    "text": "[INSTRUCTIONS (e.g. Please try to hold your toddler in the same position)]"
                },
                {
        ...
        "webcam-setup": {
            ...
            "introText": "We'll be analyzing how long your toddler looks at the screen during the videos--but only if we can tell where that is! Please check each of the following to ensure we're able to use your video:",
            ...
            "instructionBlocks": [
                ...
                {
                    "text": "During the study, we’ll ask you to sit facing towards the monitor, and hold your toddler on your lap. Make sure that the webcam is angled up or down enough that <strong>your toddler is visible in this position</strong>. (Your face doesn't have to show up in the webcam.)"
                }
            ],
            ...
            "blocks": [
                {
                    ...
                    "text": "Thank you for your participation! We appreciate you and your toddler's time and effort."
                },
                {
