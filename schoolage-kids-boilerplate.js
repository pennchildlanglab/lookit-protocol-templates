    ...
    let frames = {
            ...
            "blocks": [
                {
                    ...
                    "text": "During the study, your child will hear [DESCRIPTION OF AUDIO]. Please try playing this audio and adjust the volume so it's easy to hear.",
                    "mediaBlock": {
            ...
            "blocks": [
                {
                    ...
                    "text": "In this study, your child will listen to [DESCRIPTION]."
                },
                {
                    //Edit [INSTRUCTIONS] below
                    "text": "[INSTRUCTIONS (e.g. As the parent, your role is to make sure your child faces the monitor and pays attention to the game.)]"
                },
                {
                    "text": "If your child needs a break during the experiment, you can press the spacebar to pause. If your child no longer wants to participate, it is fine to stop the study early. You can do that by pressing ctrl-X to bring up an 'exit' option."
                },
                {
                    "text": "If you'd like to see the materials your child will be shown, you can take a look ahead of time now. It's important that you preview them without your child, so that the materials will still be new to them."
                }
            ],
        ...
        "webcam-setup": {
            ...
            "instructionBlocks": [
                ...
                {
                    "text": "During the study, we’ll ask your child to sit facing towards the monitor. You and your child can sit in any position, but please make sure that the webcam is angled up or down enough that <strong>your child’s whole face and torso are in view</strong>. "
                }, 
                {
                    "text": "Create and view a short recording on the right to make sure that your setup looks good."
                },
                {
                    "text": "Press the 'Next' button below if you and your child are in position and ready to go. The experiment will start on the next page."
                }
            ],
            "requireTestVideo": true,
            "showRecordMenu": true,
            "recordingInstructionText": "You should be able to see your camera view above. Please create and view a short recording to see how your setup looks. "
        }, 
        "end-of-experiment": {
            "kind": "exp-lookit-text", 
            "blocks": [
                {
                    ...
                    "text": "Thank you for your participation! We appreciate you and your child's time and effort."
                },
                {
                ...
                "blocks": [
                    {
                        "listblocks": [
                            ...
                            {
                                //Edit [TOPIC] and [EXPLANATION]
                                "text": "In our study, we examine [TOPIC] by [EXPLANATION]"
                            },
